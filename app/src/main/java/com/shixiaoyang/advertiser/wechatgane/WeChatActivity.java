package com.shixiaoyang.advertiser.wechatgane;
...
import com.shixiaoyang.advertiser.R;
import com.shixiaoyang.advertiser.wechatgane.bean.VersionBean;
...
public class WeChatActivity extends AppCompatActivity {
    ...
    public final static String TAG = "WeChatActivity";
    ...
    protected void testRoot() {
        try {
            ...
            Toast.makeText(WeChatActivity.this, "您的手机未root,不能使用本工具", Toast.LENGTH_LONG).show();
        }
    }
